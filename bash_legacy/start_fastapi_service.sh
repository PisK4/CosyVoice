...
echo "服务将在 http://localhost:9881 上启动"
echo "API 文档: http://localhost:9881/docs"
...
install_deps() {
    ...
    # 安装其他常见的依赖
    echo "安装其他常见依赖..."
    pip install pyyaml scipy matplotlib numba pandas scikit-learn regex transformers
...
check_critical_deps() {
    ...
    # 检查其他关键依赖
    for module in regex transformers numpy; do
